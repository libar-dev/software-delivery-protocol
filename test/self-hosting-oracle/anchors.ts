...
export const expectedAnchors = [
  ...
  {
    id: "test:protocol.delivery-facts",
    nodeType: "Anchor",
    label: "verifies the delivery-fact conferral ladder and fail-closed posture",
    type: "verifies",
    target: "spec:extraction.delivery-facts",
    file: "test/extract.test.ts",
    constant: "deliveryFactsTestAnchor",
    site: 'it("anchored-binding: the full ladder',
  },
  {
    id: "test:protocol.structural-self-binding",
    nodeType: "Anchor",
    label: "verifies the accepted significant-unit set carries its declared membership",
    type: "verifies",
    target: "spec:protocol.structural-self-binding",
    file: "test/self-hosting-graph.test.ts",
    constant: "structuralSelfBindingTestAnchor",
    site: "void structuralSelfBindingTestAnchor",
  },
  {
