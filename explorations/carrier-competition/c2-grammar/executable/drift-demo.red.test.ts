...
// Honest red demo: the value flows grammar file → spike extraction → generated contract →
// assertion, with zero test edits. The document is a copy because the TypeScript DSL remains the
// sole canonical surface during the competition.
interface World {
  lines: CartLine[];
