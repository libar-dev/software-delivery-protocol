...
The in-repo TypeScript carrier states `defined`; this exhibit states `ready`. The readiness floor
is a floor, never a quota, and the splice proof shows that both statements are honest.
