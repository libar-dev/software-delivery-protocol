...
| `docs/concept/DECISIONS.md` | **the why-log** for building the Protocol itself (the MD-series MD-1…MD-9, the ratified R-series, the legacy D1–D6 shorthand, measured evidence) — rationale + open tensions | when a choice looks arbitrary |
